...
function getLinkFunction($http, theme, util, type) {
    return function (scope, element, attrs) {
        ...
        var ndWrapper = element.find('div')[0], ndParent = element.parent()[0], parentWidth, parentHeight, width, height, chart;
        var chartEvent = {};
        function getSizes() {
        ...
        function setOptions() {
            ...
            getSizes();
            if (!chart) {
                chart = theme.get(scope.config.theme) ? echarts.init(ndWrapper, theme.get(scope.config.theme)) : echarts.init(ndWrapper);
            }
